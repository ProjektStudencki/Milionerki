...
public class sqlAdapter {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void questionAdd(SQLiteDatabase db) {
            String[][] question_values = new String[3][];
            ...
            question_values[1] = new String[]{"Jak nazywa się klub piłkarski, który zdobył Puchar Ligi Mistrzów w sezonie 2013/2014?", "Real Madryt", "FC Barcelona", "Atletico Madryt", "Bayern Monachium", "1"};
            question_values[2] = new String[]{"Jak nazywa się klub piłkarski, który zdobył Puchar Ligi Mistrzów w sezonie 2013/2014?", "Real Madryt", "FC Barcelona", "Atletico Madryt", "Bayern Monachium", "2"};
